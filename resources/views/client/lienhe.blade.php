...
<head>
    ...
    <title>Liên Hệ Với Chúng Tôi - Appilix</title>
    <meta name='description' content="Hỗ trợ khách hàng tận tâm 24/7 cho mọi người. Đừng ngần ngại đặt câu hỏi về Công cụ Chuyển đổi Web thành Ứng dụng tốt nhất."/>
    <link rel="canonical" href="https://appilix.com/contact-us" />
    <meta property="og:locale" content="vi_VN" />
    <meta property='og:type' content="website" />
    <meta property='og:title' content="Liên Hệ Với Chúng Tôi - Appilix"/>
    <meta property='og:description' content="Hỗ trợ khách hàng tận tâm 24/7 cho mọi người. Đừng ngần ngại đặt câu hỏi về Công cụ Chuyển đổi Web thành Ứng dụng tốt nhất." />
    <meta property="og:url" content="https://appilix.com/contact-us" />
    ...
    <meta name="twitter:title" content="Liên Hệ Với Chúng Tôi - Appilix" />
    <meta name="twitter:description" content="Hỗ trợ khách hàng tận tâm 24/7 cho mọi người. Đừng ngần ngại đặt câu hỏi về Công cụ Chuyển đổi Web thành Ứng dụng tốt nhất." />
    <meta name="twitter:image" content="https://appilix.com/styles/images/cover.png" />

    <link rel="stylesheet" href="https://appilix.com/styles/css/theme.css?v=3.4.8" type="text/css" media="all"/>
    ...
    "logo": "https://appilix.com/styles/images/schema/schema_logo.png",
    "description": "Appilix - Chuyển Đổi Trang Web của Bạn thành Ứng dụng Di động.",
    "sameAs": [
        "https

://www.facebook.com/appilix",
...
<!--phần hero của trang liên hệ-->
<section class="appilix_contact_section appilix_section_space_hero">
    <div class="appilix_container">
        <div class="appilix_section_header">
            <h1>Liên Hệ Với Chúng Tôi</h1>
            <p>Chúng tôi cam kết mang đến cho bạn trải nghiệm tốt nhất, được hỗ trợ bởi đội ngũ hỗ trợ xuất sắc của chúng tôi, luôn sẵn sàng giúp bạn chuyển đổi trang web thành ứng dụng.</p>
        </div>
        <div class="contact_elements">
            <div class="other_options">
                <div class="option phone_support">
                    <div class="icon"></div>
                    <h2>Hỗ Trợ Khách Hàng Nhanh Nhất</h2>
                    <p>Đội ngũ hỗ trợ của chúng tôi sẵn sàng hướng dẫn bạn qua từng bước trong quá trình chuyển đổi web thành ứng dụng. Chúng tôi thường phản hồi trong vòng 24 giờ nhưng không quá 3 ngày làm việc.</p>
                    <p>Gửi email cho chúng tôi tại <a href="/cdn-cgi/l/email-protection#84f7f1f4f4ebf6f0c4e5f4f4ede8edfcaae7ebe9"><span class="__cf_email__" data-cfemail="b6c5c3c6c6d9c4c2f6d7c6c6dfdadfce98d5d9db">[email&#160;protected]</span></a> hoặc gửi qua biểu mẫu liên hệ.</p>
                    <!--<a href="#" class="button phone_support_btn">Đặt Lịch Hẹn</a>-->
                </div>
                <div class="option chat_support">
                    <div class="icon"></div>
                    <h2>Cơ Sở Kiến Thức Mạnh Mẽ</h2>
                    <p>Chúng tôi cũng có một cơ sở kiến thức sẵn sàng dành cho bạn, nơi bạn có thể tìm thấy tất cả các giải pháp mà bạn đang tìm kiếm.</p>
                    <a target="_blank" href="https://appilix.com/knowledge-base/" class="button knowledge_base_btn">Cơ Sở Kiến Thức</a>
                </div>
            </div>
            <div class="contact_form_site">
                <h2>Gửi Tin Nhắn Cho Chúng Tôi</h2>
                <form class="contact_form" name='zsWebToCase_1043112000000435161' id='zsWebToCase_1043112000000435161' action='{{route('contact.send')}}' method='POST' onSubmit='return zsValidateMandatoryFields()' enctype='multipart/form-data'>

                    @csrf

                    <input type='hidden' name='xnQsjsdp' value='edbsnc32fd67875101b8c6061f70783b74acc'/>
                    <input type='hidden' name='xmIwtLD' value='edbsn3a60bab4647f49fde7145e35fe0e923c00b36a8a1c1a6c648d9eb65bc4e14577'/>
                    <input type='hidden' name='xJdfEaS' value=''/>
                    <input type='hidden' name='actionType' value='Q2FzZXM='/>
                    <input type="hidden" id="property(module)" value="Cases"/>
                    <input type="hidden" id="dependent_field_values_Cases" value="&#x7b;&quot;JSON_VALUES&quot;&#x3a;&#x7b;&#x7d;,&quot;JSON_SELECT_VALUES&quot;&#x3a;&#x7b;&#x7d;,&quot;JSON_MAP_DEP_LABELS&quot;&#x3a;&#x5b;&#x5d;&#x7d;"/>
                    <input type='hidden' name='returnURL' value='https&#x3a;&#x2f;&#x2f;appilix.com&#x2f;contact-us'/>

                    <div class="element selector">
                        <label class="label_title">Đây là câu hỏi về: </label>
                        <select name='topic' value='' class='select_field manfieldbdr' onchange="setDependent(this, false)" id='CASECF7'>
                            <option value='Câu Hỏi Chung' >Câu Hỏi Chung</option>
                            <option value='Vấn Đề Trong Ứng Dụng' >Vấn Đề Trong Ứng Dụng</option>
                            <option value='Yêu Cầu Tính Năng' >Yêu Cầu Tính Năng</option>
                            <option value='Vấn Đề Thanh Toán' >Vấn Đề Thanh Toán</option>
                            <option value='Vấn Đề Xuất Bản Ứng Dụng' >Vấn Đề Xuất Bản Ứng Dụng</option>
                        </select>
                    </div>
                    <div class="element F_name">
                        <label class="label_title">Họ và Tên</label>
                        <input type='text' name='name' class='input_field manfieldbdr' placeholder="Họ và Tên của bạn..." value="">
                    </div>
                    <div class="element email">
                        <label class="label_title">Email</label>
                        <input type='text' maxlength='120' name='email' class='input_field manfieldbdr' placeholder="Địa chỉ Email của bạn..." value="">
                    </div>
                    <div class="element subject">
                        <label class="label_title">Chủ Đề</label>
                        <input type='text' maxlength='255' name='subject' value='' class='input_field manfieldbdr' placeholder="Nhập chủ đề của tin nhắn...">
                    </div>
                    <div class="element message">
                        <label class="label_title">Tin Nhắn</label>
                        <textarea name='description' rows="6" placeholder="Tôi gặp vấn đề với..." class='input_field manfieldbdr'></textarea>
                    </div>

                    <div class="element ">
                        <label class="label_title">Tệp Đính Kèm <span>(Tùy chọn)</span></label>
                        <div class="file_picker" id="zsBrowseAttachment">

                            <input class="input_file" type='file' name='file' id='zsattachment_5'  />
                            <div class="input_file_display">Giới hạn tối đa 20 MB.</div>
                    ...
                    <button type="submit" id="zsSubmitButton_1043112000000435161" class="submit_button zsFontClass" value='Submit'>Gửi Tin Nhắn</button>
                </form>
            </div>
        </div>
    </div>
...
<div class="appilix_sales_notification" onclick="window.location.href='https://appilix.com/pricing';">
    ...
    <div class="sale_details">
        ...
        <h5>Vừa Mua Gói <span class="plan_title">Android Vĩnh Viễn</span></h5>
        <h6>9 giờ trước</h6>
    </div>
</div>

<!--Đăng Ký Nhận Tin Tức và Cập Nhật từ Appilix-->
...
<script type="text/javascript" src="https://appilix.com/styles/js/theme.js?v=3.4.8"></script>

<style>
    #zsFileBrowseAttachments{
        margin: 15px 0 0 0;
    }
    #zsFileBrowseAttachments .filenamecls{
        font-size: 14px;
        color: #000000;
        font-weight: 500;
        display: flex;
...
function setAllDependancyFieldsMapping(){
    ...
    if(mapDependancyLabels){
        for(var i = 0; i < mapDependancyLabels.length; i++){
            ...
            var obj = document.forms['zsWebToCase_1043112000000435161'][label];
            if(obj){
    ...
    if(val != null && val != "" && val != "null" && mySelObject){
        ...
        for(var i in fields){
            if (fields.hasOwnProperty(i)){
                ...
                var depObj = document.forms['zsWebToCase_1043112000000435161'][label];
...
var zsWebFormMandatoryFields = new Array("Support Topic","Contact Name","Email","Subject","Description");
var zsFieldsDisplayLabelArray = new Array("Chủ Đề Hỗ Trợ","Họ và Tên","Email","Chủ Đề","Mô Tả");
function zsValidateMandatoryFields(){
    ...
    for(var index = 0; index < zsWebFormMandatoryFields.length; index++){
        isError = 0;
        var fieldObject = document.forms['zsWebToCase_1043112000000435161'][zsWebFormMandatoryFields[index]];
        if(fieldObject){
            if(((fieldObject.value).replace(/^\s+|\s+$/g, '')).length == 0){
                alert(zsFieldsDisplayLabelArray[index] +' không được để trống ');
                fieldObject.focus();
                isError = 1;
                return false;
            }else{
            ...
            if(fieldObject.nodeName == 'SELECT'){
                if(fieldObject.options[fieldObject.selectedIndex].value == '-None-'){
                    alert(zsFieldsDisplayLabelArray[index] +' không được chọn không');
                    fieldObject.focus();
                    isError = 1;
                    return false;
                }
            ...
            if(fieldObject.type == 'checkbox'){
                if (fieldObject.checked == false){
                    alert('Vui lòng chấp nhận '+zsFieldsDisplayLabelArray[index]);
                    fieldObject.focus();
                    isError = 1;
                    return false;
                }
    ...
    if(isError == 0){
        document.getElementById('zsSubmitButton_1043112000000435161').setAttribute('disabled', 'disabled');
    }
}
var ZSEncoder = {
        ...
        if(zsMessageType[0] == 'zsCloudPickerMessage'){
            ...
            if(isAttachedFilesDetails[0] == 'cloudPickerResponse'){
                ...
                if(zsAttachedAttachmentsCount <= zsAllowedAttachmentLimit){
                    ...
                    alert('Bạn không thể đính kèm quá 5 tệp');
                    return false;
                }
            }
        }
            ...
            for(var attachmentsIndex = 0; attachmentsIndex < attachments.length; attachmentsIndex++){
                if(zsAttachedAttachmentsCount <= zsAllowedAttachmentLimit){
                    ...
                    if(unSupportedExtensions.indexOf(extension)!=-1){
                        alert("Tệp không được đính kèm vì phần mở rộng của nó không được hỗ trợ.");
                        continue;
                    }
        ...
        if(isZsCloudAttachmentRemoved != 1){
            jQuery.each(zsCloudAttachmentsArr[attachmentsIndex], function(attachmentsDetailJsonKey, attachmentsDetailJsonValue){
                if(attachmentsDetailJsonKey == 'docId' && attachmentsDetailJsonValue.replace(/\s/g, '') == cloudAttachmentId){
                    ...
                    zs северAttachmentsArr.splice(zsAttachmentToBeRemoved, 1);
...
function zsRenderBrowseFileAttachment(zsAttachmentObject, zsAttachmentDetails){
    if(zsAttachmentObject != ''){
        if((zsAttachmentDetails.files && (zsAttachmentDetails.files[0].size/(1024*1024))>20)){
            ...
            alert('Kích thước tệp tối đa cho phép là 20MB.');
            return;
        }
        if(zsAttachedAttachmentsCount < 5){
            var zsFileName='';
...
document.addEventListener('readystatechange',function(){
    ...
    document.getElementById('zsSubmitButton_1043112000000435161').removeAttribute('disabled');
    ...
    if(document.forms['zsWebToCase_1043112000000435161']['zsCloudPickerAttachments'] != undefined){
        var zsCloudAttachments = jQuery.parseJSON(document.forms['zsWebToCase_1043112000000435161']['zsCloudPickerAttachments'].value);
...
function zsResetWebForm(webFormId){
    ...
    zsCloudPickerJSON = {};
    if(document.forms['zsWebToCase_1043112000000435161']['zsCloudPickerAttachments'] != undefined){
        document.forms['zsWebToCase_1043112000000435161']['zsCloudPickerAttachments'].value = JSON.stringify({});
    }
    zsRearrangeFileBrowseAttachments();
    zsChangeMousePointer();
}
...
<script>
    if (document.querySelector('.appilix_discount_notification_bar')) {
        calculateDiscountTimeDifference("2025-08-05 09:20:28", "15-05-2025 23:59:59");
    }
</script>
</body>
</html>
